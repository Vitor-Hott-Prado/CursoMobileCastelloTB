...
class _ImagePickerScreenState extends State<ImagePickerScreen> {
  ...
  void _getImageFromCamer() async{
    //abrir a camera e permitir titar uma foto
    //armazenar a fot rm um arquivo temporario
    final XFile? fotoTemporaria = await _picker.pickImage(source: ImageSource.camera);
    //verificar se Xfile esta vazio
    if(fotoTemporaria !=null){
    setState(() {
      //pea a imagem temporairia e transfere para file:io
